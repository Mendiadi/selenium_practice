...
def iframe(driver: Chrome) -> [str]:
    ...
    locator(driver, By.CSS_SELECTOR,
            '#layer_cart > div.clearfix > div.layer_cart_cart.col-xs-12.col-md-6 > div.button-container > a').click()
...
def selection_register(driver: Chrome) -> [str]:
    ...
    # Define variables
    data = (
        ('firstName', "dor"), ('lastName', "cohen"), ('phone', "0529990099"), ('userName', "dorcohen111@walla.co.il")
    ...
    time.sleep(1)
    # Return validate
    actual_result = locator(driver, By.XPATH,
                            '/html/body/div[2]/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td['
                            '2]/table/tbody/tr[3]/td').text
    return actual_result, excepted_result
